...
4. If found, read ALL of:
   ...
   - test-data-strategy.md — fixture shapes, mock API responses, error codes
...
|--------|----------------------|---------------------|
| Scenario list | You derive from feature scope | Use assigned scenario IDs from test-matrix.md (your rows have `Test Level = Unit FE`) |
...
```typescript
// T-015: Filter component clears selection when category changes
